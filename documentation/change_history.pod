...
=head2 Release 004 **NOT YET RELEASED**
...
Fixed crash when running fshell --console defcons from within an fshell session.
...
Added L<qpluginloader|commands::qpluginloader> command.
